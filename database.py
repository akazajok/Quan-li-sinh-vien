...
class CsvData:
    ...
    def search_students(self, keyword):
        ...
        return [
            ...
            if keyword in s.ID.lower() or keyword in s.full_name.lower() or keyword in s.Class.lower()
        ]

    def export_to_excel(self, filename, data_list):
        if not data_list:
    ...
    def export_to_excel_gpa(self, filename, gpa_start, gpa_end):
